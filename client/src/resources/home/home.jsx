...
<div id='stars3'></div>
 ...
 <nav className='home-nav home'>
        <i className='bx bx-shape-triangle' data-aos="zoom-in-right" id='logo-shape'></i>
            ...
            <button id='login-but' data-aos="zoom-in-left" onClick={()=>{window.location.pathname='/signin'}}><i className='bx bx-user' id='bx-user'/>Sign In</button>
        </nav>
        <div className='section-1-h' onMouseOver={(e)=>{
           ...
           <h5 id='text-home-1' data-aos='zoom-in-up' data-aos-duration='500' data-aos-offset='-600'>Power up your <span className='gradient'>Business</span></h5>
            ...
            <button data-aos-offset='-100' id='section-1-b1' onClick={()=>{ window.location.pathname='/signup-business' }} data-aos="zoom-in-right">Business Account</button>
            <button data-aos-offset='-100' id='section-1-b2' onClick={()=>{ window.location.pathname='/signup-personal' }} data-aos="zoom-in-left">Personal Account</button><br/>
